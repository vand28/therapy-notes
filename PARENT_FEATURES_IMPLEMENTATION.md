...
- Created `backend/TherapyNotes.Tests` project using xUnit
...
### Backend (C#)
1. ✅ `backend/TherapyNotes.API/Controllers/AuthController.cs` - Fixed parent linking
2. ✅ `backend/TherapyNotes.API/Controllers/ParentsController.cs` - NEW
3. ✅ `backend/TherapyNotes.Tests/AuthServiceTests.cs` - NEW
4. ✅ `backend/TherapyNotes.Tests/UsageLimitServiceTests.cs` - NEW
5. ✅ `backend/TherapyNotes.Tests/ModelTests.cs` - NEW
6. ✅ `backend/TherapyNotes.Tests/IntegrationTests.cs` - NEW
7. ✅ `backend/TherapyNotes.Tests/README.md` - NEW
8. ✅ `backend/TherapyNotes.Tests/TherapyNotes.Tests.csproj` - NEW
