...
This guide will help you configure Google OAuth for the TherapyNotes application.
...
3. Enter project name: "TherapyNotes"
4. Click "Create"
...
**Backend (`backend/TherapyNotes.API/.env`):**
```env
